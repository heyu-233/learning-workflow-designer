...
当前是 Codex-first Skill；核心学习包规范保持平台无关，未来可以迁移到 ChatGPT、Claude、Obsidian、VS Code 或 CLI。
...
- 这是 Codex-first 项目，目前最完整体验仍然依赖 Codex Skill。
...
- 扩展 Prompt Pack：覆盖 ChatGPT、Claude、Obsidian、VS Code 使用方式。
